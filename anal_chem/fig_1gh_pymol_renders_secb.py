...
protein = csv_to_protein(fitresults_dir / 'ecSecB_r1' / f"r1_{fit_kwargs['r1']}" / 'fit_result.csv')
...
r2 = 2
fit_output_file = fitresults_dir / 'batch_fits' / 'SecB_tetramer_dimer' / f"r1_{fit_kwargs['r1']}_r2_{r2}" / f'fit_result.csv'
